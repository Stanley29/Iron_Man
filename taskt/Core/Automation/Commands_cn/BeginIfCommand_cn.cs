...
namespace taskt.Core.Automation.Commands_cn
{
    ...
    [Attributes.ClassAttributes.Description("此命令允许您评估逻辑语句以确定该语句是否为true。")]
    [Attributes.ClassAttributes.UsesDescription("如果要检查语句是“true”还是“false”，请使用此命令，然后根据任一条件执行操作。 任何'BeginIf'命令都必须具有以下'EndIf'命令。")]
    [Attributes.ClassAttributes.ImplementationDescription("此命令评估提供的参数，如果计算为true，则运行子元素")]
    public class BeginIfCommand_cn : ScriptCommand
    {
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("请选择If Command的类型")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("值")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("日期比较")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("变量比较")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("变量有价值")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("变量是数字")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("窗口名称存在")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("活动窗口名称是")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("文件已存在")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("文件夹存在")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("Web元素存在")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("GUI元素存在")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("发生了错误")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("没有发生错误")]
        [Attributes.PropertyAttributes.InputSpecification("选择必要的比较类型。")]
        [Attributes.PropertyAttributes.SampleUsage("选择**值**，**窗口名称存在**，**活动窗口名称为**，**文件存在**，**文件夹存在**，** Web元素存在**，**错误发生**")]
        ...
        [Attributes.PropertyAttributes.InputSpecification("选择所需的比较参数。")]
