...
namespace taskt.Core.Automation.Commands_cn
{
    ...
    [Attributes.ClassAttributes.UsesDescription("如果要关闭和结束Web浏览器会话，请使用此命令。")]
    [Attributes.ClassAttributes.ImplementationDescription("此命令实现Selenium以实现自动化。")]
    public class SeleniumBrowserCloseCommand_cn : ScriptCommand
    {
        [XmlAttribute]
        ...
        public SeleniumBrowserCloseCommand_cn()
        {
            this.CommandName = "SeleniumBrowserCloseCommand";
            // this.SelectionName = "Close Browser";
            this.SelectionName = Settings.Default.Close_Web_Browser_cn;
