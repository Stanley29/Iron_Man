...
namespace taskt.Core.Automation.Commands_cn
{
    ...
    public class SetVariableIndexCommand_cn : ScriptCommand
    {
        [XmlAttribute]
        ...
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("请设置变量的当前索引")]
        [Attributes.PropertyAttributes.PropertyUIHelper(Attributes.PropertyAttributes.PropertyUIHelper.UIAdditionalHelperType.ShowVariableHelper)]
        [Attributes.PropertyAttributes.InputSpecification("输入变量索引应设置为的输入。")]
        [Attributes.PropertyAttributes.SampleUsage("1, 2, etc.")]
        [Attributes.PropertyAttributes.Remarks("如果将变量括在括号{vName}中，则可以在输入中使用变量。 您还可以执行基本的数学运算。")]
        public string v_Index { get; set; }
        public SetVariableIndexCommand_cn()
        {
            this.CommandName = "SetVariableIndexCommand";
            // this.SelectionName = "Set Variable Index";
            this.SelectionName = Settings.Default.Set_Variable_Index_cn;
