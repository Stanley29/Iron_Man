...
namespace taskt.Core.Automation.Commands_cn
{
    ...
    [Attributes.ClassAttributes.Description("此命令允许您在Selenium Web浏览器会话中向后导航。")]
    [Attributes.ClassAttributes.UsesDescription("如果要在Web浏览器会话中模拟后退单击，请使用此命令。")]
    [Attributes.ClassAttributes.ImplementationDescription("此命令实现Selenium以实现自动化。")]
    public class SeleniumBrowserNavigateBackCommand_cn : ScriptCommand
    {
        [XmlAttribute]
        ...
        public SeleniumBrowserNavigateBackCommand_cn()
        {
            this.CommandName = "SeleniumBrowserNavigateBackCommand";
            // this.SelectionName = "Navigate Back";
            this.SelectionName = Settings.Default.Navigate_Back_cn;
