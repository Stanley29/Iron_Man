...
namespace taskt.Core.Automation.Commands_cn
{
    ...
    [Attributes.ClassAttributes.Description("此命令添加新的Excel工作簿。")]
    [Attributes.ClassAttributes.UsesDescription("如果要将新工作簿添加到Excel实例，请使用此命令")]
    [Attributes.ClassAttributes.ImplementationDescription("此命令实现Excel Interop以实现自动化。")]
    public class ExcelAddWorkbookCommand_cn : ScriptCommand
    {
        [XmlAttribute]
        ...
        public ExcelAddWorkbookCommand_cn()
        {
            this.CommandName = "ExcelAddWorkbookCommand";
            // this.SelectionName = "Add Workbook";
            this.SelectionName = Settings.Default.Add_Workbook_cn;
