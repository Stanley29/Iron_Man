...
namespace taskt.Core.Automation.Commands_cn
{
    ...
    [Attributes.ClassAttributes.Description("此命令允许您向前导航Selenium Web浏览器会话。")]
    [Attributes.ClassAttributes.UsesDescription("如果要在Web浏览器会话中模拟正向单击，请使用此命令。")]
    [Attributes.ClassAttributes.ImplementationDescription("此命令实现Selenium以实现自动化。")]
    public class SeleniumBrowserNavigateForwardCommand_cn : ScriptCommand
    {
        [XmlAttribute]
        ...
        public SeleniumBrowserNavigateForwardCommand_cn()
        {
            this.CommandName = "WebBrowserNavigateCommand";
            //this.SelectionName = "Navigate Forward";
            this.SelectionName = Settings.Default.Navigate_Forward_cn;
