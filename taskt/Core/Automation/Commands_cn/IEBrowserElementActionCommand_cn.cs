...
namespace taskt.Core.Automation.Commands_cn
{
    ...
    [Attributes.ClassAttributes.Description("此命令允许您在关联的IE Web浏览器的HTML文档中操作（获取或设置）元素。 具有辅助元素捕获形式")]
    [Attributes.ClassAttributes.ImplementationDescription("此命令从SHDocVw.dll和MSHTML.dll实现“InternetExplorer”应用程序对象以实现自动化。")]
    public class IEBrowserElementActionCommand_cn : ScriptCommand
    {
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("请输入实例名称")]
        public string v_InstanceName { get; set; }
        [XmlElement]
        [Attributes.PropertyAttributes.PropertyDescription("请输入或捕获元素搜索参数")]
        public System.Data.DataTable v_WebSearchParameter { get; set; }
        [XmlElement]
        [Attributes.PropertyAttributes.PropertyDescription("IE元素行动")]
        ...
        [Attributes.PropertyAttributes.PropertyUISelectionOption("设置属性")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("消防onmousedown事件")]
        [Attributes.PropertyAttributes.PropertyUISelectionOption("火onmouseover事件")]
        [Attributes.PropertyAttributes.InputSpecification("选择元素后要执行的相应操作")]
        [Attributes.PropertyAttributes.SampleUsage("选择**调用单击**，**设置文本**，**获取文本**，**获取属性**")]
        [Attributes.PropertyAttributes.Remarks("选择此字段将更改下一步中所需的参数")]
        public string v_WebAction { get; set; }
        [XmlElement]
        [Attributes.PropertyAttributes.PropertyDescription("动作参数")]
        ...
        public IEBrowserElementActionCommand_cn()
        {
            this.CommandName = "IEBrowserElementActionCommand";
            // this.SelectionName = "Element Action";
            this.SelectionName = Settings.Default.Element_Action_cn;
        ...
        private void ElementActionDropdown_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            Core.Automation.Commands.IEBrowserElementActionCommand_cn cmd = (Core.Automation.Commands.IEBrowserElementActionCommand_cn)this;
