...
namespace taskt.UI.Forms
{
    public partial class frmScriptEngine : ThemedForm
    {
        ...
        //ShowInputDelegate_cn//sergey added
        /*
        public delegate List<string> ShowInputDelegate_cn(Core.Automation.Commands_cn.UserInputCommand_cn inputs);
        public List<string> ShowInput_cn(Core.Automation.Commands_cn.UserInputCommand_cn inputs)
        {
            if (InvokeRequired)
            {
                var d = new ShowInputDelegate_cn(ShowInput_cn);
                Invoke(d, new object[] { inputs });
                return null;
            }
            else
